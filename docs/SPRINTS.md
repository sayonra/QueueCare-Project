...
- [x] Add branch ownership and lifecycle controls.
- [x] Add global ticket and appointment administration.
- [x] Add operational alerts and finish cross-branch acceptance checks.
