...
## Sprint 6 — platform governance (in progress)
...
- [ ] Add branch ownership and lifecycle controls.
- [ ] Add global ticket and appointment administration.
- [ ] Add operational alerts and finish cross-branch acceptance checks.
